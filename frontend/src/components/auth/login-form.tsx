  ...
  return (
    <div className={cn("flex flex-col gap-6 w-full max-w-md mx-auto", className)} {...props}>
            ...
            <FieldGroup className="space-y-6">
              ...
              <div className="flex flex-col items-center gap-2 text-center">
                ...
                <p className="text-gray-600 text-balance">
                  Đăng nhập vào tài khoản SAP của bạn
                </p>
              </div>
      ...
      <FieldDescription className="text-center text-sm text-gray-600">
        Bằng cách tiếp tục, bạn đồng ý với <a href="#" className="underline hover:text-blue-600">Điều khoản dịch vụ</a>{" "}
        và <a href="#" className="underline hover:text-blue-600">Chính sách bảo mật</a> của chúng tôi.
      </FieldDescription>
    </div>
  )
}