...
|---|---|---|
| [`backend/`](./backend) | Node.js, Express, Sequelize | API chính: xác thực, sản phẩm, đơn hàng, thanh toán, blockchain, realtime |
| [`frontend/`](./frontend) | React 19, Vite, TailwindCSS | Giao diện web cho khách hàng, cửa hàng và quản trị |
| [`modelAI/`](./modelAI) | Python, Flask, TensorFlow | Nhận diện rau củ quả qua ảnh + gợi ý sản phẩm |
...
Dự án phục vụ mục đích học tập/đồ án chuyên ngành. Vui lòng liên hệ tác giả nếu muốn sử dụng cho mục đích khác.
